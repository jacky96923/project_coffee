...
async function seed(knex) {
    ...
    let shops = [
        ...
        },
        {
            ...
            description: "我們於香港設有逾百間分店，每天為你用心沖調完美一杯，並自設中央廚房提供多款新鮮食品，部分店舖更設有獨特的設計主題或特色食品及飲品，讓你享受截然不同的咖啡體驗。",
            login_name: "shop2",
        ...
        },
        {
            ...
            description: "Walk in only Open hour : 1200 - 1600 , 1715 - 2100 (2015 last order) Open day : Mon - Sun",
            login_name: "shop3",
        ...
        },
        {
            ...
            district: "啟德",
            address: "啟德沐泰街7號區 1 座地 下4號舖",
            description: "歡迎大家大駕光臨，品嚐我地嘅作品 全都是我地用心製作 所有menu將會重新調整,價錢都會儘量平民價 做乜咖啡 是書院學生自負盈虧經營 請大家多多支持！",
            login_name: "shop4",
        ...
        },
        {
            ...
            description: "Echoing to the name of the restaurant, this is a small but cozy restaurant that is perfect for the locals.",
            login_name: "shop5",
        ...
        },
        {
            ...
            description: "Coffee + Space - 一個共享咖啡與齊聚生活愛好者的平臺。 幾個熱愛咖啡的人, 通過採購咖啡生豆, 烘焙及沖調, 誠心為客人帶來精巧而細緻的體驗。",
            login_name: "shop6",
